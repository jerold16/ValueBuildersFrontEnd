...
const InteriorHouse = () => {
  let galary = [
    "../Asset/LivingRoom3.webp",
    "../Asset/BedRoom1.webp",
    "../Asset/LivingRoom1.webp",
    "../Asset/kitchen1.webp",
    "../Asset/LivingRoom2.webp",
  ];
